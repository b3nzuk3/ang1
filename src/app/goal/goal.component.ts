...
export class GoalComponent implements OnInit {
  ...
  goals: Goal[] = [
    ...
    new Goal(3, 'Get new Phone Case', 'Diana has her birthday coming up soon', new Date(2022, 7, 12)),
    new Goal(4, 'Get Dog Food', 'Pupper likes expensive snacks', new Date(2022, 5, 18)),
